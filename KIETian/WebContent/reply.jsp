...
boolean result = (Boolean)request.getAttribute("result");
 if(result){ %>
<h5 align="center">Message Sent</h5><%} }catch(Exception e){}%>
<form action="composemsg" method="post">
<div style="padding-top: 1cm">
<h4 style="color: highlighttext;">To : </h4>
<input style="margin-left: 1.6cm;width: 25cm" type="text"  disabled="disabled" value="${to}" >
<input type="hidden" name="msgto" value="${to}">
<h4 style="color: highlighttext;">About :</h4>
<input style="margin-left: 1.6cm; width: 25cm" type="text"  disabled="disabled" value="${about}">
